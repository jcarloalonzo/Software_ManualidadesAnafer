 ...
 * @author Alumno
 */
public class FrmHistorialCatalogo extends javax.swing.JFrame {

    /**
     * Creates new form FrmHistorialCatalogo
     */
    public FrmHistorialCatalogo() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("HISTORIAL CATALOGO");
...
private void Cargar()
    ...
    String host="localhost";
        ...
        String sentenciaSQL="select * from controlCatalogo";
...
this.dispose();        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmHistorialCatalogo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmHistorialCatalogo().setVisible(true);
            }
        });
    }
