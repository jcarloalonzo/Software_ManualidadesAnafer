 ...
 * @author COCO
 */
public class FrmVistaPedido extends javax.swing.JFrame {

    /**
     * Creates new form FrmVistaPedido
     */
    public FrmVistaPedido() {
 ...
 private void Cargar()
    ...
    String host="localhost";
        ...
        String sentenciaSQL="select * from pedido WHERE EST_PED='HABILITADO'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmVistaPedido.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmVistaPedido().setVisible(true);
            }
        });
    }
